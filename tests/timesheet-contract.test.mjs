...
assert.throws(() => normalizeTimesheet([{ clientEventId: 'feb-30', occurredAt: '2026-02-30T12:00:00Z', origin: 'ORIGINAL' }]), /item 1/);
assert.throws(() => normalizeTimesheet([{ clientEventId: 'non-leap', occurredAt: '2025-02-29T12:00:00Z', origin: 'ORIGINAL' }]), /item 1/);
assert.deepEqual(normalizeTimesheet([{ clientEventId: 'leap', occurredAt: '2024-02-29T12:00:00Z', origin: 'ORIGINAL' }])[0].occurredAt, '2024-02-29T12:00:00Z');
...
assert.throws(() => normalizeTimesheet([{ clientEventId: 'evt\nforged', occurredAt: '2026-09-03T17:00:00Z', origin: 'ORIGINAL' }]), /item 1/);
assert.throws(() => normalizeTimesheet([{ clientEventId: 'm4', occurredAt: '2026-09-03T17:00:00Z', origin: 'AJUSTE_APROVADO', approvedAdjustmentIds: ['adj\rforged'] }]), /item 1/);
assert.throws(() => normalizeTimesheet([{ clientEventId: 'm5', occurredAt: '2026-09-03T17:00:00Z', origin: 'AJUSTE_APROVADO', approvedAdjustmentIds: ['adj\u0000forged'] }]), /item 1/);
assert.throws(() => normalizeTimesheet([{ clientEventId: 123, occurredAt: '2026-09-03T17:00:00Z', origin: 'ORIGINAL' }]), /item 1/);
assert.throws(() => normalizeTimesheet([{ clientEventId: ' padded ', occurredAt: '2026-09-03T17:00:00Z', origin: 'ORIGINAL' }]), /item 1/);
assert.throws(() => normalizeTimesheet([{ clientEventId: 'm6', occurredAt: '2026-09-03T17:00:00Z', origin: 'AJUSTE_APROVADO', approvedAdjustmentIds: [' adj-1 '] }]), /item 1/);
...
console.log('timesheet strict-id, ISO timestamp, calendar-validity, effective-origin, adjustment-id, control-character, duplicate-event and deterministic-order contract: PASS');
